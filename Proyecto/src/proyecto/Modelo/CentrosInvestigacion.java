...
public class CentrosInvestigacion {
    ...
    public CentrosInvestigacion(String nombre_institucion, String area_cientifica, String subarea_cientifica){
        this.nombre_institucion = nombre_institucion;
        this.area_cientifica = area_cientifica;
        this.subarea_cientifica = subarea_cientifica;
    }
    public CentrosInvestigacion(String nombre_institucion, String investigacion_cientifica, Date vigencia_inicio, Date vigencia_fin){
        this.nombre_institucion = nombre_institucion;
        this.investigacion_cientifica = investigacion_cientifica;
        this.vigencia_inicio = vigencia_inicio;
        this.vigencia_fin = vigencia_fin;
    ...
    public CentrosInvestigacion(String nombre_institucion, String disciplina_cientifica, String innovacion_tecnologica, Date vigencia_inicio, Date vigencia_fin){
        this.nombre_institucion = nombre_institucion;
        this.disciplina_cientifica = disciplina_cientifica;
        this.innovacion_tecnologica = innovacion_tecnologica;
        this.vigencia_inicio = vigencia_inicio;
